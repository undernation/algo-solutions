...
직사각형의 변은 좌표축과 평행하며, 이 복원본의 좌표 범위는 다음과 같다.
...
3. 면적과 블록 수가 모두 같으면 구역 ID가 작을수록 우선한다.

세 번째 기준은 **“구역 ID가 작은 순서였던 것 같다”는 기억을 채택한 것**으로,
원문과 일치하는지 아직 확정되지 않았다.
